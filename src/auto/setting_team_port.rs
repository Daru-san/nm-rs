...
impl SettingTeamPort {
    ...
    pub fn new() -> SettingTeamPort {
        ...
        unsafe {
            Setting::from_glib_full(ffi::nm_setting_team_port_new()).unsafe_cast()
        }
    }
    ...
    pub fn add_link_watcher(&self, link_watcher: &TeamLinkWatcher) -> bool {
        unsafe {
            from_glib(ffi::nm_setting_team_port_add_link_watcher(self.to_glib_none().0, link_watcher.to_glib_none().0))
        }
    }
    ...
    pub fn config(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::nm_setting_team_port_get_config(self.to_glib_none().0))
        }
    }
    ...
    pub fn lacp_key(&self) -> i32 {
        unsafe {
            ffi::nm_setting_team_port_get_lacp_key(self.to_glib_none().0)
        }
    }
    ...
    pub fn lacp_prio(&self) -> i32 {
        unsafe {
            ffi::nm_setting_team_port_get_lacp_prio(self.to_glib_none().0)
        }
    }
    ...
    pub fn link_watcher(&self, idx: u32) -> TeamLinkWatcher {
        unsafe {
            from_glib_none(ffi::nm_setting_team_port_get_link_watcher(self.to_glib_none().0, idx))
        }
    }
    ...
    pub fn num_link_watchers(&self) -> u32 {
        unsafe {
            ffi::nm_setting_team_port_get_num_link_watchers(self.to_glib_none().0)
        }
    }
    ...
    pub fn prio(&self) -> i32 {
        unsafe {
            ffi::nm_setting_team_port_get_prio(self.to_glib_none().0)
        }
    }
    ...
    pub fn queue_id(&self) -> i32 {
        unsafe {
            ffi::nm_setting_team_port_get_queue_id(self.to_glib_none().0)
        }
    }
    ...
    pub fn is_sticky(&self) -> bool {
        unsafe {
            from_glib(ffi::nm_setting_team_port_get_sticky(self.to_glib_none().0))
        }
    }
    ...
    pub fn remove_link_watcher_by_value(&self, link_watcher: &TeamLinkWatcher) -> bool {
        unsafe {
            from_glib(ffi::nm_setting_team_port_remove_link_watcher_by_value(self.to_glib_none().0, link_watcher.to_glib_none().0))
        }
    }
    ...
    pub fn connect_config_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_config_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    pub fn connect_lacp_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_lacp_key_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::lacp-key".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_lacp_key_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_lacp_prio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_lacp_prio_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::lacp-prio".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_lacp_prio_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_link_watchers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_link_watchers_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_prio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_prio_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_queue_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_queue_id_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_sticky_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sticky_trampoline<F: Fn(&SettingTeamPort) + 'static>(this: *mut ffi::NMSettingTeamPort, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::sticky".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_sticky_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct SettingTeamPortBuilder {
    ...
    pub fn lacp_key(self, lacp_key: i32) -> Self {
                            Self { builder: self.builder.property("lacp-key", lacp_key), }
                        }

                            #[cfg(feature = "v1_12")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_12")))]
    pub fn lacp_prio(self, lacp_prio: i32) -> Self {
                            Self { builder: self.builder.property("lacp-prio", lacp_prio), }
                        }
    ...
    pub fn sticky(self, sticky: bool) -> Self {
                            Self { builder: self.builder.property("sticky", sticky), }
                        }
