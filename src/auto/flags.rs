...
#[doc(hidden)]
impl IntoGlib for ApFlags80211 {
...
#[doc(hidden)]
impl FromGlib<ffi::NM80211ApFlags> for ApFlags80211 {
    #[inline]
...
impl StaticType for ApFlags80211 {
    #[inline]
...
impl glib::HasParamSpec for ApFlags80211 {
...
impl glib::value::ValueType for ApFlags80211 {
    type Type = Self;
}

unsafe impl<'a> glib::value::FromValue<'a> for ApFlags80211 {
...
impl From<ApFlags80211> for glib::Value {
    #[inline]
    fn from(v: ApFlags80211) -> Self {
        skip_assert_initialized!();
        ToValue::to_value(&v)
    }
}
...
bitflags! {
    ...
    pub struct ApSecurityFlags80211: u32 {
...
#[doc(hidden)]
impl IntoGlib for ApSecurityFlags80211 {
...
#[doc(hidden)]
impl FromGlib<ffi::NM80211ApSecurityFlags> for ApSecurityFlags80211 {
    #[inline]
...
impl StaticType for ApSecurityFlags80211 {
    #[inline]
...
impl glib::HasParamSpec for ApSecurityFlags80211 {
    type ParamSpec = glib::ParamSpecFlags;
    type SetValue = Self;
    type BuilderFn = fn(&str) -> glib::ParamSpecFlagsBuilder<Self>;
...
impl glib::value::ValueType for ApSecurityFlags80211 {
    type Type = Self;
}

unsafe impl<'a> glib::value::FromValue<'a> for ApSecurityFlags80211 {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl ToValue for ApSecurityFlags80211 {
    #[inline]
    fn to_value(&self) -> glib::Value {
        let mut value = glib::Value::for_value_type::<Self>();
        unsafe {
...
impl From<ApSecurityFlags80211> for glib::Value {
    #[inline]
    fn from(v: ApSecurityFlags80211) -> Self {
        skip_assert_initialized!();
        ToValue::to_value(&v)
    }
}
